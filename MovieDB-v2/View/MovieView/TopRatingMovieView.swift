...
import UIKit
import SDWebImage
class TopRatingMovieView: UIView {
...
extension TopRatingMovieView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
